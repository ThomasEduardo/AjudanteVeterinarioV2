...
@XmlRootElement
@Entity
@Table(name = "tb_fazendaInteressada")
@NamedQuery(name = "FazendaInteressada.getAll", query = "from FazendaInteressada")
public class FazendaInteressada {
	...
	//Default Constructor
	public FazendaInteressada(){

	}
	
	public FazendaInteressada(String nome_fazenda, String nome_representate, String email, String mensagem) {
		super();
